...
{
    public static class EFCoreInitalizerHelper
    {
        public static IServiceCollection AddAllDbContext(this IServiceCollection services, Action<DbContextOptionsBuilder> builder,
